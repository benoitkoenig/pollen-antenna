...
export default function mapFeatureToSubdivision(feature: Feature) {
  ...
  let northBound = coordinates[0][0][0] as number;
  let southBound = coordinates[0][0][0] as number;
  let eastBound = coordinates[0][0][1] as number;
  let westBound = coordinates[0][0][1] as number;
